...
export const ErrorPage: React.FC = () => {
  ...
  return (
    <div className="font-['Merriweather_Sans'] flex flex-col justify-center items-center h-screen w-screen bg-white">

      <ErrorIcon />

      <div className="flex flex-col items-center justify-center text-center mb-8">
        <p className="text-3xl font-semibold" id="errorText">PÁGINA NO ENCONTRADA.</p>
      </div>
      <Link
        id="errorLink"
        to="/"
        className="inline-flex items-center text-xl px-3 py-3 border border-black text-black bg-transparent no-underline transition-all duration-500 ease-in-out hover:bg-black hover:text-white"
      >
  ...
  return (
    ...
    >
      ...
      <g transform="translate(170.14515,0.038164)" id="layer1">
        <g id="g6219" className="origin-[85px_4px] animate-[swing_12s_0.5s_infinite_ease-out]">
          <path
            transform="matrix(1.0150687,0,0,11.193923,-1.3895945,-2685.7441)"
            style={{ display: 'inline', fill: '#000000', fillOpacity: 1, stroke: '#000000', strokeWidth: '0.1px', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeOpacity: 1 }}
          ...
          <g id="g6174">
            <ellipse
              ...
              cx="84.963676"
              id="path4488"
              style={{ display: 'inline', opacity: 1, fill: 'none', fillOpacity: 0.4627451, fillRule: 'nonzero', stroke: '#000000', strokeWidth: 1.08691013, strokeMiterlimit: 4, strokeOpacity: 1 }}
            />
            <path
              id="path4490"
              ...
              style={{ display: 'inline', fill: '#000000', stroke: 'none', strokeWidth: '0.23743393px', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeOpacity: 1 }}
            />
            <path
              id="path4496"
              ...
              style={{ display: 'inline', fill: '#000000', fillOpacity: 1, stroke: '#000000', strokeWidth: '1px', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeOpacity: 1 }}
            />
            <rect
              ry="5"
              y="314.84082"
              ...
              width="100.76272"
              id="rect4553"
              style={{ display: 'inline', opacity: 1, fill: '#000000', fillOpacity: 1, fillRule: 'nonzero', stroke: '#000000', strokeWidth: 1.00157475, strokeMiterlimit: 4, strokeOpacity: 1 }}
            />
            <path
              id="path4513"
              ...
              style={{ display: 'inline', fill: 'none', stroke: '#000000', strokeWidth: '1px', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeOpacity: 1 }}
            />
            <path
              id="path4517"
            ...
            <path
              ...
              style={{ display: 'inline', fill: 'none', stroke: '#000000', strokeWidth: '1.00614154px', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeOpacity: 1 }}
            />
            <path
              id="path4529"
            ...
            <ellipse
              ...
              cx="85.016434"
              id="path4616"
              style={{ display: 'inline', opacity: 1, fill: '#000000', fillOpacity: 1, fillRule: 'nonzero', stroke: '#000000', strokeWidth: 0.82170224, strokeMiterlimit: 4, strokeOpacity: 1 }}
            />
            <ellipse
              ...
              cx="321.42224"
              id="path4565"
              style={{ opacity: 1, fill: '#000000', fillOpacity: 1, fillRule: 'nonzero', stroke: '#000000', strokeWidth: 1.00157475, strokeMiterlimit: 4, strokeOpacity: 1 }}
            />
            <path
              transform="translate(-170.14515,-0.038164)"
              id="path4567"
            ...
            <path
              ...
              style={{ fill: '#000000', fillOpacity: 1, stroke: '#000000', strokeWidth: '1px', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeOpacity: 1 }}
            />
          </g>
        </g>
      </g>
      <g id="layer3">
        ...
        >
          <path
            id="path4555"
            style={{ fill: 'black', fillOpacity: 1, stroke: '#000000', strokeWidth: 1.23488784, strokeOpacity: 1 }}
